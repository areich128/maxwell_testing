 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 28 13:31:15 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                dcm_2_q
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 dcm
#define INPUT_0_DIMS_ND                {3,3}
#define INPUT_0_NUM_ELEMS              9
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port dcm of S-Function dcm_2_q");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port q of S-Function dcm_2_q");
      return;
    }
...
{
  const real32_T *dcm = (real32_T *) ssGetInputPortRealSignal(S, 0);
  real32_T *q = (real32_T *) ssGetOutputPortRealSignal(S, 0);
   ...
   */
  real32_T *dcm_t = (real32_T *)ssGetDWork(S, 0);
  real32_T *q_t = (real32_T *)ssGetDWork(S, 1);
  NDTransposeBySrcSpecs((void*)dcm_t, (const void*)dcm, ssGetInputPortDimensions
                        (S, 0), ssGetInputPortNumDimensions(S, 0), sizeof
                        (real32_T));
  dcm_2_q_Outputs_wrapper(dcm_t, q_t);
  NDTransposeByDstSpecs((void*)q, (const void*)q_t, ssGetOutputPortDimensions(S,
