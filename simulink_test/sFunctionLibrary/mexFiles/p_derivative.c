 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 28 12:58:13 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                p_derivative
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port A of S-Function p_derivative");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port B of S-Function p_derivative");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port lamb of S-Function p_derivative");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function p_derivative");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *lamb = (real32_T *) ssGetInputPortRealSignal(S, 2);
  ...
  real32_T *lamb_t = (real32_T *)ssGetDWork(S, 2);
  real32_T *y0_t = (real32_T *)ssGetDWork(S, 3);
  ...
  p_derivative_Outputs_wrapper(A_t, B_t, lamb_t, y0_t);
