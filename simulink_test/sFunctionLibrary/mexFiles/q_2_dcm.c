 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 28 13:33:75 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                q_2_dcm
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q of S-Function q_2_dcm");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port dcm of S-Function q_2_dcm");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real32_T *dcm = (real32_T *) ssGetOutputPortRealSignal(S, 0);
