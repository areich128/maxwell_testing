 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Jan 27 12:27:22 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                control_fdbk
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 q_des_RN
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port op_mode of S-Function control_fdbk");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q_BN of S-Function control_fdbk");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q_des_RN of S-Function control_fdbk");
      return;
    }
