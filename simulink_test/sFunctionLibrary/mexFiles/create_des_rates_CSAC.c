 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Oct 31 12:30:12 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                create_des_rates_CSAC
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 phi_cone
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port opmode of S-Function create_des_rates_CSAC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q_BN of S-Function create_des_rates_CSAC");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port phi_cone of S-Function create_des_rates_CSAC");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port des_rates_bf of S-Function create_des_rates_CSAC");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *phi_cone = (real32_T *) ssGetInputPortRealSignal(S, 2);
  real_T *des_rates_bf = (real_T *) ssGetOutputPortRealSignal(S, 0);
  ...
  real32_T *phi_cone_t = (real32_T *)ssGetDWork(S, 2);
  real_T *des_rates_bf_t = (real_T *)ssGetDWork(S, 3);
  ...
  NDTransposeBySrcSpecs((void*)phi_cone_t, (const void*)phi_cone,
                        ssGetInputPortDimensions(S, 2),
                        ssGetInputPortNumDimensions(S, 2), sizeof(real32_T));
  create_des_rates_CSAC_Outputs_wrapper(opmode_t, q_BN_t, phi_cone_t,
    des_rates_bf_t);
