 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 28 13:01:72 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                gs_to_sc_vec
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                gs_2_sc
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sc_pos_vec_ecef of S-Function gs_to_sc_vec");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port gnd_stn_pos_vec_ecef of S-Function gs_to_sc_vec");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port gs_2_sc of S-Function gs_to_sc_vec");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *gnd_stn_pos_vec_ecef = (real32_T *) ssGetInputPortRealSignal(S,
    1);
  real32_T *gs_2_sc = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  ...
  real32_T *gs_2_sc_t = (real32_T *)ssGetDWork(S, 2);
  ...
  gs_to_sc_vec_Outputs_wrapper(sc_pos_vec_ecef_t, gnd_stn_pos_vec_ecef_t,
    gs_2_sc_t);
  NDTransposeByDstSpecs((void*)gs_2_sc, (const void*)gs_2_sc_t,
