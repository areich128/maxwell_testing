...
#define S_FUNCTION_NAME                sc_to_gs_vec
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                sc_2_gs
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sc_pos_vec_ecef of S-Function sc_to_gs_vec");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port gnd_stn_pos_vec_ecef of S-Function sc_to_gs_vec");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port sc_2_gs of S-Function sc_to_gs_vec");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *gnd_stn_pos_vec_ecef = (real32_T *) ssGetInputPortRealSignal(S,
    1);
  real32_T *sc_2_gs = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  ...
  real32_T *sc_2_gs_t = (real32_T *)ssGetDWork(S, 2);
  ...
  sc_to_gs_vec_Outputs_wrapper(sc_pos_vec_ecef_t, gnd_stn_pos_vec_ecef_t,
    sc_2_gs_t);
  NDTransposeByDstSpecs((void*)sc_2_gs, (const void*)sc_2_gs_t,
