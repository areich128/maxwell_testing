 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Oct 31 13:02:25 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                calc_q_er
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q_bn of S-Function calc_q_er");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q_rn of S-Function calc_q_er");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port q_br of S-Function calc_q_er");
      return;
    }
...
{
  const real32_T *q_bn = (real32_T *) ssGetInputPortRealSignal(S, 0);
  const real32_T *q_rn = (real32_T *) ssGetInputPortRealSignal(S, 1);
  real32_T *q_br = (real32_T *) ssGetOutputPortRealSignal(S, 0);
   ...
   */
  real32_T *q_bn_t = (real32_T *)ssGetDWork(S, 0);
  real32_T *q_rn_t = (real32_T *)ssGetDWork(S, 1);
  real32_T *q_br_t = (real32_T *)ssGetDWork(S, 2);
  ...
  NDTransposeBySrcSpecs((void*)q_rn_t, (const void*)q_rn,
                        ssGetInputPortDimensions(S, 1),
                        ssGetInputPortNumDimensions(S, 1), sizeof(real32_T));
  calc_q_er_Outputs_wrapper(q_bn_t, q_rn_t, q_br_t);
