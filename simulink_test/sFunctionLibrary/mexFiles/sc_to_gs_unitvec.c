 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 28 13:24:99 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                sc_to_gs_unitvec
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                sc_2_gs_normlzd
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port sc_pos_vec_ecef of S-Function sc_to_gs_unitvec");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port gnd_stn_pos_vec_ecef of S-Function sc_to_gs_unitvec");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port sc_2_gs_normlzd of S-Function sc_to_gs_unitvec");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *gnd_stn_pos_vec_ecef = (real32_T *) ssGetInputPortRealSignal(S,
    1);
  real32_T *sc_2_gs_normlzd = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  ...
  real32_T *sc_2_gs_normlzd_t = (real32_T *)ssGetDWork(S, 2);
  ...
  sc_to_gs_unitvec_Outputs_wrapper(sc_pos_vec_ecef_t, gnd_stn_pos_vec_ecef_t,
    sc_2_gs_normlzd_t);
  NDTransposeByDstSpecs((void*)sc_2_gs_normlzd, (const void*)sc_2_gs_normlzd_t,
