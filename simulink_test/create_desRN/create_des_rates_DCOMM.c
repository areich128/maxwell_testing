 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Oct 23 16:54:41 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                create_des_rates_DCOMM
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                gnd_ecef
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                des_rates_bf
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port opmode of S-Function create_des_rates_DCOMM");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port pos_ecef of S-Function create_des_rates_DCOMM");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port leapsec of S-Function create_des_rates_DCOMM");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port q_BN of S-Function create_des_rates_DCOMM");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port gnd_ecef of S-Function create_des_rates_DCOMM");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port des_rates_bf of S-Function create_des_rates_DCOMM");
      return;
    }
   ...
   */
  ssSetDWorkDataType(S, 5, ssGetOutputPortDataType(S, 1));
  ssSetDWorkUsageType(S, 5, SS_DWORK_USED_AS_SCRATCH);
  ssSetDWorkName(S, 5, "des_rates_bf_t");
  ssSetDWorkWidth(S, 5, ssGetOutputPortWidth(S, 1));
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *pos_ecef = (real32_T *) ssGetInputPortRealSignal(S, 1);
  const uint8_T *leapsec = (uint8_T *) ssGetInputPortRealSignal(S, 2);
  const real32_T *q_BN = (real32_T *) ssGetInputPortRealSignal(S, 3);
  real32_T *gnd_ecef = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *des_rates_bf = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  ...
  real32_T *pos_ecef_t = (real32_T *)ssGetDWork(S, 1);
  uint8_T *leapsec_t = (uint8_T *)ssGetDWork(S, 2);
  real32_T *q_BN_t = (real32_T *)ssGetDWork(S, 3);
  real32_T *gnd_ecef_t = (real32_T *)ssGetDWork(S, 4);
  ...
  NDTransposeBySrcSpecs((void*)pos_ecef_t, (const void*)pos_ecef,
  ...
  NDTransposeBySrcSpecs((void*)q_BN_t, (const void*)q_BN,
                        ssGetInputPortDimensions(S, 3),
                        ssGetInputPortNumDimensions(S, 3), sizeof(real32_T));
  create_des_rates_DCOMM_Outputs_wrapper(opmode_t, pos_ecef_t, leapsec_t, q_BN_t,
    gnd_ecef_t, des_rates_bf_t);
  NDTransposeByDstSpecs((void*)gnd_ecef, (const void*)gnd_ecef_t,
