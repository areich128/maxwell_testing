 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Oct 10 17:27:55 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                create_desRN_Simulink
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port opmode of S-Function create_desRN_Simulink");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port des_vec of S-Function create_desRN_Simulink");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port des_RN of S-Function create_desRN_Simulink");
      return;
    }
