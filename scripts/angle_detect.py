...
while True:
    ...
    center = detect_circle(frame, lower_black, upper_black, lower_white, upper_white) # FOR CSS TEST
    # center = detect_circle(frame, lower_black, upper_black, lower_black, upper_black) # FOR HWRE TEST
